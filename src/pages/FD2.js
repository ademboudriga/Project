...
function FD2() {
    ...
    useEffect(() => {
        ...
        axios.get('http://135.125.203.248:8000/authentication/usersList/?page=2')
            .then(response => {
        ...
        <div>
            ...
            {authData && (
                <div>
                    ...
                    <p><strong>Next:</strong> <a href='/FD3'>{authData.next}</a></p>
                    <p><strong>Previous:</strong> <a href='http://localhost:3000/'></a>{authData.previous}</p>
                    <h4>Results:</h4>
