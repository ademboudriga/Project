...
function FD3() {
    ...
    useEffect(() => {
        ...
        axios.get('http://135.125.203.248:8000/authentication/usersList/?page=3')
            .then(response => {
        ...
        <div>
            ...
            {authData && (
                <div>
                    ...
                    <p><strong>Next:</strong> <a href='/FD4'>{authData.next}</a></p>
                    <p><strong>Previous:</strong> <a href='/FD2'></a>{authData.previous}</p>
                    <h4>Results:</h4>
